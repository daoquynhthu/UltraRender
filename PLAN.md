...
**状态**: 进行中。Q.0-Q.6 原生格式、SceneIR serialization、deterministic procedural graph、显式 script build hook 与 backend-neutral native resource catalog 已完成；当前后续游标为 Q.7。
