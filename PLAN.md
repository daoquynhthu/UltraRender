...
**状态**: 进行中。Q.0-Q.9 原生格式、SceneIR serialization、procedural/script build、native resources、solver/integrator、physics/acoustic open contract 与 CLI/API tooling 已完成；当前后续游标为 Q.10。
