...
#define PRINT_LAYOUT(type, format, ...) std::printf(#type "|%zu|%zu|" format "\\n", sizeof(type), alignof(type), __VA_ARGS__)

int main() {
    std::fputs("{\"schema\":\"ure.public.abi-layout/windows-x64/0.1\",\"layout_signature\":\"", stdout);
