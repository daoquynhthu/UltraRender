...
static_assert(sizeof(ure_runtime_interface_t) == 24);
static_assert(sizeof(ure_instance_interface_t) == 48);
static_assert(sizeof(ure_error_interface_t) == 40);
static_assert(sizeof(ure_operation_interface_t) == 56);
static_assert(sizeof(ure_event_interface_t) == 32);
