...
> **Historical snapshot:** This document is retained for architecture history. Current status, build commands, and construction order are defined only by `AGENTS.md` and `PLAN.md`.
