...
| V (GPU Acceleration) | In progress | V.0-V.1 complete; V.2 self-compute BVH baseline is the authoritative cursor |
...
- Phase Q, Phase M, Phase R, and Phase T are complete; V.0-V.1 are complete and the authoritative construction cursor is V.2.
