...
| Q.0-Q.7 (Native Scene) | Done | Native container/schema, SceneIR serialization, procedural/script build, resource catalog, solver/integrator capability contract |
...
| **CTest total** | **32 registered tests** in `build_modular_x64` |
