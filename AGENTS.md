...
| V (GPU Acceleration) | In progress | V.0-V.6 complete; V.7 cross-provider parity is the authoritative cursor |
...
- Phase Q, Phase M, Phase R, and Phase T are complete; V.0-V.6 are complete and the authoritative construction cursor is V.7.
