...
| V (GPU Acceleration) | In progress | V.0 audit complete; V.1 AccelerationConfig API is the authoritative cursor |
...
- Phase Q, Phase M, Phase R, and Phase T are complete; V.0 is complete and the authoritative construction cursor is V.1.
