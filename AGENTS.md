...
| Q.0-Q.6 (Native Scene) | Done | Native container/schema, SceneIR serialization, procedural graph, script build contract, typed spectral/material/medium resource catalog |
...
| **CTest total** | **31 registered tests** in `build_modular_x64` |
