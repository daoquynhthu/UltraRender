...
| Q.0-Q.9 (Native Scene) | Done | Native container/schema, SceneIR serialization, procedural/script build, resource/solver/simulation contracts, CLI/API tooling |
...
| **CTest total** | **34 registered tests** in `build_modular_x64` |
