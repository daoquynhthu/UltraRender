...
| T (Portable GPU Runtime) | In progress | T.0 coupling audit complete; T.1 backend identity/capability is the authoritative cursor |
...
- Phase Q, Phase M, and Phase R are complete; T.0 is complete and the authoritative construction cursor is T.1.
