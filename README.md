...
- Phase Q、Phase R、Phase T 与 Phase V 已完成。Phase W.2 的 diffraction camera、W.5 的 diffractive MaterialGraph operators 与 W.6 的 fluorescence material 已接入显式启用的 CUDA wavefront 路径；当前施工游标是 `W.7`。
