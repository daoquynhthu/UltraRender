...
- R-P7 已建立版本化工业验证报告和本地 quick gate，聚合八类带哈希证据及 MSE、方差、色差、time-to-error 和吞吐指标。BDPT/VCM 独立收益、farm/Nsight closure 与完整高级积分器收益/边界矩阵尚未闭环，不能据此声明 Phase R 完成。见 [Phase R-P7 文档](docs/Phase_R_P7_Industrial_Validation.md)。
