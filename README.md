...
- Phase Q、Phase R、Phase T 与 Phase V 已完成。Phase W.2 的 diffraction camera、W.5 的 diffractive MaterialGraph operators 与 W.6 的 fluorescence material 已接入显式启用的 CUDA wavefront 路径；W.7、W.9、W.10 与 W.11 已分别建立部分相干统计、各向异性模态、局部全波交换和相干分布式充分统计合同，当前施工游标是 `W.12`。
