...
try {
    ...
    Assert-Contains "scripts/run_phase_t_validation_suite.ps1" "variance_mse" "T.11 statistical evidence is missing"
    Assert-Contains "scripts/run_phase_t_validation_suite.ps1" "device_loss" "T.11 device-loss evidence is missing"
    Assert-Contains "scripts/run_phase_t_validation_suite.ps1" "cold_warm_launch" "T.11 launch evidence is missing"
