...
try {
    ...
    $historicalPlan = "docs/archive/Legacy_Construction_PLAN_2026-08-01.md"
    Assert-Contains $historicalPlan "状态.*已完成.*V\.0-V\.11" "Archived construction PLAN does not close Phase V"
    Assert-Contains $historicalPlan "V\.0 closure.*权威游标进入 V\.1" "Archived construction PLAN lacks the V.0 closure and V.1 gate"
    Assert-Contains $historicalPlan "V\.1 closure.*权威游标进入 V\.2" "Archived construction PLAN lacks the V.1 closure and V.2 gate"
    Assert-Contains $historicalPlan "V\.2 closure.*权威游标进入 V\.3" "Archived construction PLAN lacks the V.2 closure and V.3 gate"
    Assert-Contains $historicalPlan "V\.3 closure.*权威游标进入 V\.4" "Archived construction PLAN lacks the V.3 closure and V.4 gate"
    Assert-Contains $historicalPlan "V\.4 closure.*权威游标进入 V\.5" "Archived construction PLAN lacks the V.4 closure and V.5 gate"
    Assert-Contains $historicalPlan "V\.5 closure.*权威游标进入 V\.6" "Archived construction PLAN lacks the V.5 closure and V.6 gate"
    Assert-Contains $historicalPlan "V\.6 closure.*权威游标进入 V\.7" "Archived construction PLAN lacks the V.6 closure and V.7 gate"
    Assert-Contains $historicalPlan "V\.7 closure.*权威游标进入 V\.8" "Archived construction PLAN lacks the V.7 closure and V.8 gate"
    Assert-Contains $historicalPlan "V\.8 closure.*权威游标进入 V\.9" "Archived construction PLAN lacks the V.8 closure and V.9 gate"
    Assert-Contains $historicalPlan "V\.9 closure.*权威游标进入 V\.10" "Archived construction PLAN lacks the V.9 closure and V.10 gate"
    Assert-Contains $historicalPlan "V\.10 closure.*权威游标进入 V\.11" "Archived construction PLAN lacks the V.10 closure and V.11 gate"
    Assert-Contains $historicalPlan "V\.11 closure.*权威游标进入 W\.2" "Archived construction PLAN lacks the V.11 closure and W.2 gate"
    Assert-Contains "README.md" "可选 OptiX" "README misstates OptiX optionality"
    Assert-Contains "STATUS.md" "No maintained arbitrary-scene radiometric product path" "STATUS misstates the portable acceleration boundary"
