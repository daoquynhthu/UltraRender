...
Assert-Contains "libs\ure_core\src\bidirectional_runtime.cu" "strategy_edges\[0\]\.reverse_measure_pdf" "R-P4 connection reverse area-measure density"
Assert-Contains "libs\ure_core\src\bidirectional_runtime.cu" "bidirectional_strategy_mis_weight" "R-P4 full strategy MIS consumption"
