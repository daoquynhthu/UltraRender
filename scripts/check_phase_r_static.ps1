...
Assert-Contains "libs\ure_core\src\path_tracer_host_api.cu" "BDPT/VCM camera-light connection is under R-P4 implementation" "R-P4 estimator completion fail-loud"
