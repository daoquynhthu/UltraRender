...
> Archive status: read-only snapshot of the former root plan, superseded by the PRV route on 2026-08-11. Completion records remain valid within their stated boundaries, but cursor and future-work statements are historical.
...
[`Legacy_Construction_PLAN_2026-08-01.md`](Legacy_Construction_PLAN_2026-08-01.md)，
...
**架构权威**: [`docs/Public_API_ABI_Architecture.md`](../Public_API_ABI_Architecture.md)。

**实施细则**: [`docs/PB_Public_Boundary_PLAN.md`](../PB_Public_Boundary_PLAN.md)。
