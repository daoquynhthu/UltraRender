...
| [`PB_Public_Boundary_PLAN.md`](PB_Public_Boundary_PLAN.md) | Active subordinate PB.0-PB.8 implementation sequence; PB.0-PB.1 are complete and PB.2 is current |
...
[`archive/Legacy_Construction_PLAN_2026-08-01.md`](archive/Legacy_Construction_PLAN_2026-08-01.md) is the frozen former root roadmap for completed Q/R/T/V/W/U construction and the deferred Phase X proposal. It is useful for design history but cannot override the current `PB.2 — Windows x64 loader ABI and candidate runtime product` cursor. Phase PB is a client interaction boundary, not revival of the archived third-party plugin design.
