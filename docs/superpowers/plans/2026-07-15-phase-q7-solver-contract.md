...
4. Integrate native archive chunk 20 and required `ure.render.solver` feature.
5. Add host roundtrip, mapping, unsupported-mode, non-degradation, and hash tests.
6. Run Release build, 32-test CTest, schema, Q/L/R, and physics-optics gates.
