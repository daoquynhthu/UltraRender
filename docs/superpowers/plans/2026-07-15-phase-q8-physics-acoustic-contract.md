...
4. Integrate native archive chunk 21 and required feature declaration.
5. Add fail-loud, optional preservation, coupling, migration, and roundtrip tests.
6. Run Release, 33-test, schema, Phase Q/L/R, and physics-optics gates.
