...
4. Add the URSB schema contract, chunk/feature ownership, and static audit.
5. Add host contract tests and run targeted, full, schema, Phase Q/L/R, and physics-optics gates.
