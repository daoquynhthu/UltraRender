...
Json build_manifest() {
    ...
    extension_types["ure_device_descriptor_t"] = layout<ure_device_descriptor_t>();
    field<ure_output_header_t>(extension_types["ure_device_descriptor_t"], "header", offsetof(ure_device_descriptor_t, header));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "backend", offsetof(ure_device_descriptor_t, backend));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "provider", offsetof(ure_device_descriptor_t, provider));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "runtime_state", offsetof(ure_device_descriptor_t, runtime_state));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "ordinal", offsetof(ure_device_descriptor_t, ordinal));
    field<ure_digest256_t>(extension_types["ure_device_descriptor_t"], "device_identity", offsetof(ure_device_descriptor_t, device_identity));
    field<std::uint64_t>(extension_types["ure_device_descriptor_t"], "features", offsetof(ure_device_descriptor_t, features));
    field<std::uint64_t>(extension_types["ure_device_descriptor_t"], "total_memory_bytes", offsetof(ure_device_descriptor_t, total_memory_bytes));
    field<std::uint64_t>(extension_types["ure_device_descriptor_t"], "available_memory_bytes", offsetof(ure_device_descriptor_t, available_memory_bytes));
    field<std::uint64_t>(extension_types["ure_device_descriptor_t"], "applicable_budget_bytes", offsetof(ure_device_descriptor_t, applicable_budget_bytes));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "vendor_id", offsetof(ure_device_descriptor_t, vendor_id));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "device_id", offsetof(ure_device_descriptor_t, device_id));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "name_size", offsetof(ure_device_descriptor_t, name_size));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "adapter_id_size", offsetof(ure_device_descriptor_t, adapter_id_size));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "driver_identity_size", offsetof(ure_device_descriptor_t, driver_identity_size));
    field<std::uint32_t>(extension_types["ure_device_descriptor_t"], "compiler_identity_size", offsetof(ure_device_descriptor_t, compiler_identity_size));
    field<char[128]>(extension_types["ure_device_descriptor_t"], "name", offsetof(ure_device_descriptor_t, name));
    field<char[128]>(extension_types["ure_device_descriptor_t"], "adapter_id", offsetof(ure_device_descriptor_t, adapter_id));
    field<char[128]>(extension_types["ure_device_descriptor_t"], "driver_identity", offsetof(ure_device_descriptor_t, driver_identity));
    field<char[128]>(extension_types["ure_device_descriptor_t"], "compiler_identity", offsetof(ure_device_descriptor_t, compiler_identity));
    field<std::uint64_t[2]>(extension_types["ure_device_descriptor_t"], "reserved", offsetof(ure_device_descriptor_t, reserved));
    extension_types["ure_execution_info_t"] = layout<ure_execution_info_t>();
    field<ure_output_header_t>(extension_types["ure_execution_info_t"], "header", offsetof(ure_execution_info_t, header));
    field<std::uint32_t>(extension_types["ure_execution_info_t"], "backend", offsetof(ure_execution_info_t, backend));
    field<std::uint32_t>(extension_types["ure_execution_info_t"], "provider", offsetof(ure_execution_info_t, provider));
    field<std::uint32_t>(extension_types["ure_execution_info_t"], "runtime_state", offsetof(ure_execution_info_t, runtime_state));
    field<std::uint32_t>(extension_types["ure_execution_info_t"], "ordinal", offsetof(ure_execution_info_t, ordinal));
    field<ure_digest256_t>(extension_types["ure_execution_info_t"], "device_identity", offsetof(ure_execution_info_t, device_identity));
    field<ure_digest256_t>(extension_types["ure_execution_info_t"], "plan_identity", offsetof(ure_execution_info_t, plan_identity));
    field<std::uint64_t>(extension_types["ure_execution_info_t"], "required_features", offsetof(ure_execution_info_t, required_features));
    field<std::uint64_t>(extension_types["ure_execution_info_t"], "selected_memory_budget_bytes", offsetof(ure_execution_info_t, selected_memory_budget_bytes));
    field<std::uint64_t>(extension_types["ure_execution_info_t"], "total_memory_bytes", offsetof(ure_execution_info_t, total_memory_bytes));
    field<std::uint64_t>(extension_types["ure_execution_info_t"], "available_memory_bytes", offsetof(ure_execution_info_t, available_memory_bytes));
    field<std::uint32_t>(extension_types["ure_execution_info_t"], "name_size", offsetof(ure_execution_info_t, name_size));
    field<std::uint32_t>(extension_types["ure_execution_info_t"], "adapter_id_size", offsetof(ure_execution_info_t, adapter_id_size));
    field<char[128]>(extension_types["ure_execution_info_t"], "name", offsetof(ure_execution_info_t, name));
    field<char[128]>(extension_types["ure_execution_info_t"], "adapter_id", offsetof(ure_execution_info_t, adapter_id));
    field<std::uint64_t[2]>(extension_types["ure_execution_info_t"], "reserved", offsetof(ure_execution_info_t, reserved));
    ...
    extension_types["ure_measurement_frame_info_t"] = layout<ure_measurement_frame_info_t>();
    field<ure_output_header_t>(extension_types["ure_measurement_frame_info_t"], "header", offsetof(ure_measurement_frame_info_t, header));
    field<ure_digest256_t>(extension_types["ure_measurement_frame_info_t"], "frame_identity", offsetof(ure_measurement_frame_info_t, frame_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_frame_info_t"], "measurement_identity", offsetof(ure_measurement_frame_info_t, measurement_identity));
    field<std::uint64_t>(extension_types["ure_measurement_frame_info_t"], "generation", offsetof(ure_measurement_frame_info_t, generation));
    field<std::uint64_t>(extension_types["ure_measurement_frame_info_t"], "retained_bytes", offsetof(ure_measurement_frame_info_t, retained_bytes));
    field<std::uint32_t>(extension_types["ure_measurement_frame_info_t"], "plane_count", offsetof(ure_measurement_frame_info_t, plane_count));
    field<std::uint32_t>(extension_types["ure_measurement_frame_info_t"], "publication_status", offsetof(ure_measurement_frame_info_t, publication_status));
    field<std::uint64_t[2]>(extension_types["ure_measurement_frame_info_t"], "reserved", offsetof(ure_measurement_frame_info_t, reserved));
    extension_types["ure_measurement_plane_info_t"] = layout<ure_measurement_plane_info_t>();
    field<ure_output_header_t>(extension_types["ure_measurement_plane_info_t"], "header", offsetof(ure_measurement_plane_info_t, header));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "plane_schema", offsetof(ure_measurement_plane_info_t, plane_schema));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "scalar_type", offsetof(ure_measurement_plane_info_t, scalar_type));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "component_layout", offsetof(ure_measurement_plane_info_t, component_layout));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "normalization", offsetof(ure_measurement_plane_info_t, normalization));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "width", offsetof(ure_measurement_plane_info_t, width));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "height", offsetof(ure_measurement_plane_info_t, height));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "depth", offsetof(ure_measurement_plane_info_t, depth));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "element_stride", offsetof(ure_measurement_plane_info_t, element_stride));
    field<std::uint64_t>(extension_types["ure_measurement_plane_info_t"], "row_stride", offsetof(ure_measurement_plane_info_t, row_stride));
    field<std::uint64_t>(extension_types["ure_measurement_plane_info_t"], "slice_stride", offsetof(ure_measurement_plane_info_t, slice_stride));
    field<std::uint64_t>(extension_types["ure_measurement_plane_info_t"], "byte_extent", offsetof(ure_measurement_plane_info_t, byte_extent));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "observable_identity", offsetof(ure_measurement_plane_info_t, observable_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "unit_identity", offsetof(ure_measurement_plane_info_t, unit_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "measure_identity", offsetof(ure_measurement_plane_info_t, measure_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "time_identity", offsetof(ure_measurement_plane_info_t, time_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "uncertainty_identity", offsetof(ure_measurement_plane_info_t, uncertainty_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "provenance_identity", offsetof(ure_measurement_plane_info_t, provenance_identity));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_info_t"], "content_identity", offsetof(ure_measurement_plane_info_t, content_identity));
    field<std::uint64_t>(extension_types["ure_measurement_plane_info_t"], "sample_begin", offsetof(ure_measurement_plane_info_t, sample_begin));
    field<std::uint64_t>(extension_types["ure_measurement_plane_info_t"], "sample_count", offsetof(ure_measurement_plane_info_t, sample_count));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "endpoint_index", offsetof(ure_measurement_plane_info_t, endpoint_index));
    field<std::uint32_t>(extension_types["ure_measurement_plane_info_t"], "flags", offsetof(ure_measurement_plane_info_t, flags));
    field<std::uint64_t[2]>(extension_types["ure_measurement_plane_info_t"], "reserved", offsetof(ure_measurement_plane_info_t, reserved));
    extension_types["ure_measurement_plane_copy_t"] = layout<ure_measurement_plane_copy_t>();
    field<ure_input_header_t>(extension_types["ure_measurement_plane_copy_t"], "header", offsetof(ure_measurement_plane_copy_t, header));
    field<ure_handle_t>(extension_types["ure_measurement_plane_copy_t"], "frame", offsetof(ure_measurement_plane_copy_t, frame));
    field<std::uint32_t>(extension_types["ure_measurement_plane_copy_t"], "plane_index", offsetof(ure_measurement_plane_copy_t, plane_index));
    field<std::uint32_t>(extension_types["ure_measurement_plane_copy_t"], "reserved32", offsetof(ure_measurement_plane_copy_t, reserved32));
    field<std::uint64_t>(extension_types["ure_measurement_plane_copy_t"], "source_offset", offsetof(ure_measurement_plane_copy_t, source_offset));
    field<std::uint64_t>(extension_types["ure_measurement_plane_copy_t"], "byte_count", offsetof(ure_measurement_plane_copy_t, byte_count));
    field<ure_mutable_byte_span_t>(extension_types["ure_measurement_plane_copy_t"], "destination", offsetof(ure_measurement_plane_copy_t, destination));
    field<std::uint64_t>(extension_types["ure_measurement_plane_copy_t"], "expected_generation", offsetof(ure_measurement_plane_copy_t, expected_generation));
    field<ure_digest256_t>(extension_types["ure_measurement_plane_copy_t"], "expected_content_identity", offsetof(ure_measurement_plane_copy_t, expected_content_identity));
    field<std::uint64_t[2]>(extension_types["ure_measurement_plane_copy_t"], "reserved", offsetof(ure_measurement_plane_copy_t, reserved));
    extension_types["ure_output_request_t"] = layout<ure_output_request_t>();
    field<ure_input_header_t>(extension_types["ure_output_request_t"], "header", offsetof(ure_output_request_t, header));
    field<ure_handle_t>(extension_types["ure_output_request_t"], "job", offsetof(ure_output_request_t, job));
    field<std::uint32_t>(extension_types["ure_output_request_t"], "format", offsetof(ure_output_request_t, format));
    field<std::uint32_t>(extension_types["ure_output_request_t"], "tone_map", offsetof(ure_output_request_t, tone_map));
    field<ure_string_view_t>(extension_types["ure_output_request_t"], "output_path", offsetof(ure_output_request_t, output_path));
    field<std::uint32_t>(extension_types["ure_output_request_t"], "output_count", offsetof(ure_output_request_t, output_count));
    field<const std::uint32_t *>(extension_types["ure_output_request_t"], "output_semantics", offsetof(ure_output_request_t, output_semantics));
    field<std::uint64_t>(extension_types["ure_output_request_t"], "byte_budget", offsetof(ure_output_request_t, byte_budget));
    field<std::uint64_t[2]>(extension_types["ure_output_request_t"], "reserved", offsetof(ure_output_request_t, reserved));
    extension_types["ure_output_manifest_t"] = layout<ure_output_manifest_t>();
    field<ure_output_header_t>(extension_types["ure_output_manifest_t"], "header", offsetof(ure_output_manifest_t, header));
    field<std::uint32_t>(extension_types["ure_output_manifest_t"], "publication_status", offsetof(ure_output_manifest_t, publication_status));
    field<std::uint32_t>(extension_types["ure_output_manifest_t"], "format", offsetof(ure_output_manifest_t, format));
    field<std::uint64_t>(extension_types["ure_output_manifest_t"], "artifact_count", offsetof(ure_output_manifest_t, artifact_count));
    field<std::uint64_t>(extension_types["ure_output_manifest_t"], "byte_count", offsetof(ure_output_manifest_t, byte_count));
    field<ure_digest256_t>(extension_types["ure_output_manifest_t"], "manifest_identity", offsetof(ure_output_manifest_t, manifest_identity));
    field<ure_digest256_t>(extension_types["ure_output_manifest_t"], "measurement_identity", offsetof(ure_output_manifest_t, measurement_identity));
    field<ure_digest256_t>(extension_types["ure_output_manifest_t"], "content_identity", offsetof(ure_output_manifest_t, content_identity));
    field<std::uint64_t[2]>(extension_types["ure_output_manifest_t"], "reserved", offsetof(ure_output_manifest_t, reserved));
    extension_types["ure_measurement_output_interface_t"] = layout<ure_measurement_output_interface_t>();
    field<ure_interface_table_header_t>(extension_types["ure_measurement_output_interface_t"], "header", offsetof(ure_measurement_output_interface_t, header));
    field<decltype(ure_measurement_output_interface_t::get_frame_info)>(extension_types["ure_measurement_output_interface_t"], "get_frame_info", offsetof(ure_measurement_output_interface_t, get_frame_info));
    field<decltype(ure_measurement_output_interface_t::get_plane_info)>(extension_types["ure_measurement_output_interface_t"], "get_plane_info", offsetof(ure_measurement_output_interface_t, get_plane_info));
    field<decltype(ure_measurement_output_interface_t::copy_plane_range)>(extension_types["ure_measurement_output_interface_t"], "copy_plane_range", offsetof(ure_measurement_output_interface_t, copy_plane_range));
    field<decltype(ure_measurement_output_interface_t::publish_artifacts)>(extension_types["ure_measurement_output_interface_t"], "publish_artifacts", offsetof(ure_measurement_output_interface_t, publish_artifacts));
    extension_types["ure_scene_tool_request_t"] = layout<ure_scene_tool_request_t>();
    field<ure_input_header_t>(extension_types["ure_scene_tool_request_t"], "header", offsetof(ure_scene_tool_request_t, header));
    field<std::uint32_t>(extension_types["ure_scene_tool_request_t"], "operation", offsetof(ure_scene_tool_request_t, operation));
    field<std::uint32_t>(extension_types["ure_scene_tool_request_t"], "input_count", offsetof(ure_scene_tool_request_t, input_count));
    field<const ure_string_view_t *>(extension_types["ure_scene_tool_request_t"], "input_paths", offsetof(ure_scene_tool_request_t, input_paths));
    field<ure_string_view_t>(extension_types["ure_scene_tool_request_t"], "output_path", offsetof(ure_scene_tool_request_t, output_path));
    field<ure_string_view_t>(extension_types["ure_scene_tool_request_t"], "package_scene_id", offsetof(ure_scene_tool_request_t, package_scene_id));
    field<ure_scene_budget_t>(extension_types["ure_scene_tool_request_t"], "budget", offsetof(ure_scene_tool_request_t, budget));
    field<std::uint64_t>(extension_types["ure_scene_tool_request_t"], "temporary_budget_bytes", offsetof(ure_scene_tool_request_t, temporary_budget_bytes));
    field<ure_mutable_byte_span_t>(extension_types["ure_scene_tool_request_t"], "report_buffer", offsetof(ure_scene_tool_request_t, report_buffer));
    ...
    field<std::uint32_t>(extension_types["ure_scene_tool_result_t"], "disposition_count", offsetof(ure_scene_tool_result_t, disposition_count));
    field<std::uint32_t>(extension_types["ure_scene_tool_result_t"], "diagnostic_count", offsetof(ure_scene_tool_result_t, diagnostic_count));
    field<ure_digest256_t>(extension_types["ure_scene_tool_result_t"], "snapshot_identity", offsetof(ure_scene_tool_result_t, snapshot_identity));
    field<ure_digest256_t>(extension_types["ure_scene_tool_result_t"], "semantic_identity", offsetof(ure_scene_tool_result_t, semantic_identity));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "stored_bytes", offsetof(ure_scene_tool_result_t, stored_bytes));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "decompressed_bytes", offsetof(ure_scene_tool_result_t, decompressed_bytes));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "resident_bytes", offsetof(ure_scene_tool_result_t, resident_bytes));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "streamed_bytes", offsetof(ure_scene_tool_result_t, streamed_bytes));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "temporary_bytes", offsetof(ure_scene_tool_result_t, temporary_bytes));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "output_bytes", offsetof(ure_scene_tool_result_t, output_bytes));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "scene_count", offsetof(ure_scene_tool_result_t, scene_count));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "resource_count", offsetof(ure_scene_tool_result_t, resource_count));
    field<std::uint64_t>(extension_types["ure_scene_tool_result_t"], "cache_count", offsetof(ure_scene_tool_result_t, cache_count));
    ...
    extension_types["ure_device_execution_interface_t"] = layout<ure_device_execution_interface_t>();
    field<ure_interface_table_header_t>(extension_types["ure_device_execution_interface_t"], "header", offsetof(ure_device_execution_interface_t, header));
    field<decltype(ure_device_execution_interface_t::enumerate)>(extension_types["ure_device_execution_interface_t"], "enumerate", offsetof(ure_device_execution_interface_t, enumerate));
    field<decltype(ure_device_execution_interface_t::get_descriptor)>(extension_types["ure_device_execution_interface_t"], "get_descriptor", offsetof(ure_device_execution_interface_t, get_descriptor));
    field<decltype(ure_device_execution_interface_t::get_job_execution)>(extension_types["ure_device_execution_interface_t"], "get_job_execution", offsetof(ure_device_execution_interface_t, get_job_execution));
